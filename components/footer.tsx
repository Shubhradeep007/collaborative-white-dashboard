            ...
            <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
                <div className="xl:grid xl:grid-cols-3 xl:gap-8">
                    <div className="space-y-8">
                        <div className="flex items-center space-x-2">
                            <Image src="/logo.png" alt="Sparky" width={32} height={32} />
                            <span className="text-xl font-bold text-gray-900 dark:text-white">Sparky</span>
                        </div>
                        <p className="text-sm leading-6 text-gray-600 dark:text-gray-400">
                            Collaborate, brainstorm, and build together with your team in real-time.
                        </p>
                    ...
                    <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0 xl:flex xl:justify-end xl:gap-20">
                ...
                <div className="mt-16 border-t border-gray-900/10 dark:border-white/10 pt-8 sm:mt-20 lg:mt-24">
                    <p className="text-xs leading-5 text-gray-500 dark:text-gray-400">
                        &copy; {new Date().getFullYear()} Sparky, Inc. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
